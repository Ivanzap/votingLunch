package ru.ivanzap.votinglunch.web;
...
import ru.ivanzap.votinglunch.util.exception.*;
import ru.ivanzap.votinglunch.util.validation.ValidationUtil;

import javax.servlet.http.HttpServletRequest;
import java.util.Map;

import static ru.ivanzap.votinglunch.util.exception.ErrorType.*;
...
public class ExceptionInfoHandler {
    ...
    public static final String EXCEPTION_DUPLICATE_DATETIME = "exception.vote.duplicateDateTime";
    public static final String EXCEPTION_DUPLICATE_NAME = "exception.restaurant.duplicateName";

    private static final Map<String, String> CONSTRAINS_I18N_MAP = Map.of(
            "users_unique_email_idx", EXCEPTION_DUPLICATE_EMAIL,
            "votes_unique_user_datetime_idx", EXCEPTION_DUPLICATE_DATETIME,
